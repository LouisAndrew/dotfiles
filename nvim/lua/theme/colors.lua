...
Color.new("mfed_0", minimal_fedu.shades_of_grey[1])
Color.new("mfed_1", minimal_fedu.shades_of_grey[2])
Color.new("mfed_2", minimal_fedu.shades_of_grey[3])
Color.new("mfed_3", minimal_fedu.shades_of_grey[4])
Color.new("mfed_4", minimal_fedu.shades_of_grey[5])
Color.new("mfed_5", minimal_fedu.shades_of_grey[6])
Color.new("mfed_6", minimal_fedu.shades_of_grey[7])
Color.new("mfed_7", minimal_fedu.shades_of_grey[8])
Color.new("mfed_8", minimal_fedu.shades_of_grey[9])
Color.new("mfed_9", minimal_fedu.shades_of_grey[10])
