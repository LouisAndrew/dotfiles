...
return lush(function()
  return {
    ...
    NoiceCmdlineIcon({ fg = palette.cyan }),
    NoiceCmdlineIconCalculator({ fg = palette.peach }),
    NoiceCmdlineIconCmdline({ fg = palette.cyan }),
    NoiceCmdlineIconFilter({ fg = palette.subtle }),
    NoiceCmdlineIconHelp({ fg = palette.lavender }),
    NoiceCmdlineIconIncRename({ fg = palette.yellow }),
    NoiceCmdlineIconInput({ fg = palette.peach }),
    NoiceCmdlineIconLua({ fg = palette.purple }),
