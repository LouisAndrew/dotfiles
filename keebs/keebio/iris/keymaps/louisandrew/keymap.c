...
[_LOWER] = LAYOUT(
  ...
  KC_LCTL , KC_LBRC , KC_LEFT , KC_RBRC , KC_UP   , KC_LBRC ,                           KC_LEFT , KC_DOWN , KC_UP , KC_RGHT , KC_MINS , KC_EQL ,
  KC_LSFT , KC_TRNS , KC_TRNS , KC_TRNS , KC_DOWN , KC_LALT , S(KC_RBRC) ,     KC_SPC , KC_P1   , KC_P2   , KC_P3 , KC_MINS , KC_MINS , KC_RSFT,
